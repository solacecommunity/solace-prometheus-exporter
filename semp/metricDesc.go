...
var MetricDesc = map[string]Metrics{
	...
	"ReplicationStats": {
		...
		"system_replication_xa_req":                  prometheus.NewDesc(namespace+"_"+"system_replication_xa_req", "Replication transaction requests", variableLabelsReplication, nil),
		"system_replication_xa_req_success":          prometheus.NewDesc(namespace+"_"+"system_replication_xa_req_success", "Replication transaction requests success", variableLabelsReplication, nil),
		"system_replication_xa_req_success_prepare":  prometheus.NewDesc(namespace+"_"+"system_replication_xa_req_success_prepare", "Replication transaction requests success prepare", variableLabelsReplication, nil),
		"system_replication_xa_req_success_commit":   prometheus.NewDesc(namespace+"_"+"system_replication_xa_req_success_commit", "Replication transaction requests success commit", variableLabelsReplication, nil),
		"system_replication_xa_req_success_rollback": prometheus.NewDesc(namespace+"_"+"system_replication_xa_req_success_rollback", "Replication transaction requests success rollback", variableLabelsReplication, nil),
		"system_replication_xa_req_fail":             prometheus.NewDesc(namespace+"_"+"system_replication_xa_req_fail", "Replication transaction requests fail", variableLabelsReplication, nil),
		"system_replication_xa_req_fail_prepare":     prometheus.NewDesc(namespace+"_"+"system_replication_xa_req_fail_prepare", "Replication transaction requests fail prepare", variableLabelsReplication, nil),
		"system_replication_xa_req_fail_commit":      prometheus.NewDesc(namespace+"_"+"system_replication_xa_req_fail_commit", "Replication transaction requests fail commit", variableLabelsReplication, nil),
		"system_replication_xa_req_fail_rollback":    prometheus.NewDesc(namespace+"_"+"system_replication_xa_req_fail_rollback", "Replication transaction requests fail rollback", variableLabelsReplication, nil),
	},
	"Vpn": {
	...
	"VpnReplication": {
		...
		"vpn_replication_transaction_replication_mode": prometheus.NewDesc(namespace+"_"+"vpn_replication_transaction_replication_mode", "Replication Transaction Replication Mode (0-async, 1-sync)", variableLabelsVpn, nil),
	},
	"ConfigSyncVpn": {
	...
	"ClientMessageSpoolStats": {
		...
		"guaranteed_messages":               prometheus.NewDesc(namespace+"_"+"client_ingress_guaranteed_messages", "Number of guarantied messages, received.", variableLabelsVpnClientFlow, nil),
		...
		"ingress_window_size":               prometheus.NewDesc(namespace+"_"+"client_ingress_window_size", "Configured window size", variableLabelsVpnClientFlow, nil),

		"egress_window_size":                    prometheus.NewDesc(namespace+"_"+"client_egress_window_size", "Configured window size", variableLabelsVpnClientFlow, nil),
	...
	"BridgeStats": {
		...
		"bridge_denied_duplicate_clients":               prometheus.NewDesc(namespace+"_"+"bridge_denied_duplicate_clients", "Bridge Denied Duplicate Clients", variableLabelsBridgeStats, nil),
	...
	"QueueRates": {
		...
		"queue_rx_msg_rate_avg":  prometheus.NewDesc(namespace+"_"+"queue_rx_msg_rate_avg", "Average rate of received messages.", variableLabelsVpnQueue, nil),
		"queue_tx_msg_rate_avg":  prometheus.NewDesc(namespace+"_"+"queue_tx_msg_rate_avg", "Average rate of transmitted messages.", variableLabelsVpnQueue, nil),
		"queue_rx_byte_rate_avg": prometheus.NewDesc(namespace+"_"+"queue_rx_byte_rate_avg", "Average rate of received bytes.", variableLabelsVpnQueue, nil),
		"queue_tx_byte_rate_avg": prometheus.NewDesc(namespace+"_"+"queue_tx_byte_rate_avg", "Average rate of transmitted bytes.", variableLabelsVpnQueue, nil),
	},
	"QueueDetails": {
	...
	"TopicEndpointRates": {
		...
		"rx_msg_rate_avg":  prometheus.NewDesc(namespace+"_"+"topic_endpoint_rx_msg_rate_avg", "Average rate of received messages.", variableLabelsVpnTopicEndpoint, nil),
		"tx_msg_rate_avg":  prometheus.NewDesc(namespace+"_"+"topic_endpoint_tx_msg_rate_avg", "Average rate of transmitted messages.", variableLabelsVpnTopicEndpoint, nil),
		"rx_byte_rate_avg": prometheus.NewDesc(namespace+"_"+"topic_endpoint_rx_byte_rate_avg", "Average rate of received bytes.", variableLabelsVpnTopicEndpoint, nil),
		"tx_byte_rate_avg": prometheus.NewDesc(namespace+"_"+"topic_endpoint_tx_byte_rate_avg", "Average rate of transmitted bytes.", variableLabelsVpnTopicEndpoint, nil),
	},
	"TopicEndpointDetails": {
		...
		"binds":             prometheus.NewDesc(namespace+"_"+"topic_endpoint_binds", "Number of clients bound to topic-endpoint.", variableLabelsVpnTopicEndpoint, nil),
	},
	"TopicEndpointStats": {
	...
	"ClusterLinks": {
		"enabled":     prometheus.NewDesc(namespace+"_"+"cluster_link_enabled", "Cluster link is enabled.", variableLabelsCluserLink, nil),
		"oper_up":     prometheus.NewDesc(namespace+"_"+"cluster_link_operational", "Cluster link is operational.", variableLabelsCluserLink, nil),
		"oper_uptime": prometheus.NewDesc(namespace+"_"+"cluster_link_uptime", "Cluster link uptime in seconds.", variableLabelsCluserLink, nil),
	},
	"ClientConnections": {
