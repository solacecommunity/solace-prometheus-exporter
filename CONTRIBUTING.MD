...
```sh
git clone https://github.com/solacecommunity/solace-prometheus-exporter
```
...
```sh
$ git remote add upstream https://github.com/solacecommunity/solace-prometheus-exporter
```
