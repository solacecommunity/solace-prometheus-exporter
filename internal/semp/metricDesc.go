...
var MetricDesc = map[string]Descriptions{
	...
	"SpoolStats": {
		// Discard counters
		"system_spool_stats_discard_spooling_not_ready":                   NewSemDesc("system_spool_stats_discard_spooling_not_ready", NoSempV2Ready, "Messages discarded because spooling not ready.", nil),
		"system_spool_stats_discard_out_of_order":                         NewSemDesc("system_spool_stats_discard_out_of_order", NoSempV2Ready, "Messages discarded due to out of order.", nil),
		"system_spool_stats_discard_duplicate":                            NewSemDesc("system_spool_stats_discard_duplicate", NoSempV2Ready, "Duplicate messages discarded.", nil),
		"system_spool_stats_discard_no_destination":                       NewSemDesc("system_spool_stats_discard_no_destination", NoSempV2Ready, "Messages discarded with no destination.", nil),
		"system_spool_stats_discard_spool_over_quota":                     NewSemDesc("system_spool_stats_discard_spool_over_quota", NoSempV2Ready, "Messages discarded due to spool over quota.", nil),
		"system_spool_stats_discard_queue_endpoint_over_quota":            NewSemDesc("system_spool_stats_discard_queue_endpoint_over_quota", NoSempV2Ready, "Messages discarded due to queue endpoint over quota.", nil),
		"system_spool_stats_discard_replay_log_over_quota":                NewSemDesc("system_spool_stats_discard_replay_log_over_quota", NoSempV2Ready, "Messages discarded due to replay log over quota.", nil),
		"system_spool_stats_discard_max_msg_usage_exceeded":               NewSemDesc("system_spool_stats_discard_max_msg_usage_exceeded", NoSempV2Ready, "Messages discarded due to max message usage exceeded.", nil),
		"system_spool_stats_discard_max_msg_size_exceeded":                NewSemDesc("system_spool_stats_discard_max_msg_size_exceeded", NoSempV2Ready, "Messages discarded due to max message size exceeded.", nil),
		"system_spool_stats_discard_remote_router_spooling_not_supported": NewSemDesc("system_spool_stats_discard_remote_router_spooling_not_supported", NoSempV2Ready, "Messages discarded due to remote router spooling not supported.", nil),
		"system_spool_stats_discard_spool_to_adb_fail":                    NewSemDesc("system_spool_stats_discard_spool_to_adb_fail", NoSempV2Ready, "Messages discarded due to spool to ADB failure.", nil),
		"system_spool_stats_discard_spool_to_disk_fail":                   NewSemDesc("system_spool_stats_discard_spool_to_disk_fail", NoSempV2Ready, "Messages discarded due to spool to disk failure.", nil),
		"system_spool_stats_discard_spool_file_limit_exceeded":            NewSemDesc("system_spool_stats_discard_spool_file_limit_exceeded", NoSempV2Ready, "Messages discarded due to spool file limit exceeded.", nil),
		"system_spool_stats_discard_errored_message":                      NewSemDesc("system_spool_stats_discard_errored_message", NoSempV2Ready, "Errored messages discarded.", nil),
		"system_spool_stats_discard_queue_not_found":                      NewSemDesc("system_spool_stats_discard_queue_not_found", NoSempV2Ready, "Messages discarded due to queue not found.", nil),
		"system_spool_stats_spool_shutdown_discard":                       NewSemDesc("system_spool_stats_spool_shutdown_discard", NoSempV2Ready, "Messages discarded due to spool shutdown.", nil),
		"system_spool_stats_user_profile_deny_guaranteed":                 NewSemDesc("system_spool_stats_user_profile_deny_guaranteed", NoSempV2Ready, "Messages discarded due to user profile denying guaranteed.", nil),
		"system_spool_stats_discard_publisher_not_found":                  NewSemDesc("system_spool_stats_discard_publisher_not_found", NoSempV2Ready, "Messages discarded due to publisher not found.", nil),
		"system_spool_stats_no_local_delivery_discard":                    NewSemDesc("system_spool_stats_no_local_delivery_discard", NoSempV2Ready, "Messages discarded due to no local delivery.", nil),
		"system_spool_stats_smf_ttl_exceeded":                             NewSemDesc("system_spool_stats_smf_ttl_exceeded", NoSempV2Ready, "Messages discarded due to SMF TTL exceeded.", nil),
		"system_spool_stats_publish_acl_denied":                           NewSemDesc("system_spool_stats_publish_acl_denied", NoSempV2Ready, "Messages discarded due to publish ACL denied.", nil),
		"system_spool_stats_destination_group_error":                      NewSemDesc("system_spool_stats_destination_group_error", NoSempV2Ready, "Messages discarded due to destination group error.", nil),
		"system_spool_stats_not_compatible_with_forwarding_mode":          NewSemDesc("system_spool_stats_not_compatible_with_forwarding_mode", NoSempV2Ready, "Messages discarded due to incompatibility with forwarding mode.", nil),
		"system_spool_stats_low_priority_msg_congestion_discard":          NewSemDesc("system_spool_stats_low_priority_msg_congestion_discard", NoSempV2Ready, "Low priority messages discarded due to congestion.", nil),
		"system_spool_stats_replication_is_standby_discard":               NewSemDesc("system_spool_stats_replication_is_standby_discard", NoSempV2Ready, "Messages discarded because replication is standby.", nil),
		"system_spool_stats_sync_replication_ineligible_discard":          NewSemDesc("system_spool_stats_sync_replication_ineligible_discard", NoSempV2Ready, "Messages discarded due to sync replication ineligibility.", nil),
		"system_spool_stats_xa_transaction_not_supported":                 NewSemDesc("system_spool_stats_xa_transaction_not_supported", NoSempV2Ready, "Messages discarded due to XA transaction not supported.", nil),
		"system_spool_stats_discard_other":                                NewSemDesc("system_spool_stats_discard_other", NoSempV2Ready, "Messages discarded due to other reasons.", nil),
		"system_spool_stats_total_discarded_messages":                     NewSemDesc("system_spool_stats_total_discarded_messages", NoSempV2Ready, "Total messages discarded.", nil),
		// TTL and redelivery counters
		"system_spool_stats_total_deleted_messages":                   NewSemDesc("system_spool_stats_total_deleted_messages", NoSempV2Ready, "Total messages deleted.", nil),
		"system_spool_stats_total_ttl_expired_discard_messages":       NewSemDesc("system_spool_stats_total_ttl_expired_discard_messages", NoSempV2Ready, "Total messages discarded due to TTL expiry.", nil),
		"system_spool_stats_total_ttl_expired_to_dmq_messages":        NewSemDesc("system_spool_stats_total_ttl_expired_to_dmq_messages", NoSempV2Ready, "Total messages sent to DMQ due to TTL expiry.", nil),
		"system_spool_stats_total_ttl_expired_to_dmq_failures":        NewSemDesc("system_spool_stats_total_ttl_expired_to_dmq_failures", NoSempV2Ready, "Total failures sending to DMQ due to TTL expiry.", nil),
		"system_spool_stats_max_redelivery_exceeded_discard_messages": NewSemDesc("system_spool_stats_max_redelivery_exceeded_discard_messages", NoSempV2Ready, "Messages discarded due to max redelivery exceeded.", nil),
		"system_spool_stats_max_redelivery_exceeded_to_dmq_messages":  NewSemDesc("system_spool_stats_max_redelivery_exceeded_to_dmq_messages", NoSempV2Ready, "Messages sent to DMQ due to max redelivery exceeded.", nil),
		"system_spool_stats_max_redelivery_exceeded_to_dmq_failures":  NewSemDesc("system_spool_stats_max_redelivery_exceeded_to_dmq_failures", NoSempV2Ready, "Failures sending to DMQ due to max redelivery exceeded.", nil),
		"system_spool_stats_total_ttl_exceeded_discard_messages":      NewSemDesc("system_spool_stats_total_ttl_exceeded_discard_messages", NoSempV2Ready, "Total messages discarded due to TTL exceeded.", nil),
		// Ingress counters
		"system_spool_stats_ingress_messages":                       NewSemDesc("system_spool_stats_ingress_messages", NoSempV2Ready, "Total ingress messages.", nil),
		"system_spool_stats_ingress_messages_promoted":              NewSemDesc("system_spool_stats_ingress_messages_promoted", NoSempV2Ready, "Ingress messages promoted. Message sent as non-persistent but received as persistent.", nil),
		"system_spool_stats_ingress_messages_demoted":               NewSemDesc("system_spool_stats_ingress_messages_demoted", NoSempV2Ready, "Ingress messages demoted. Message sent as persistent but received as non-persistent.", nil),
		"system_spool_stats_promoted_messages_replicated":           NewSemDesc("system_spool_stats_promoted_messages_replicated", NoSempV2Ready, "Promoted messages replicated.", nil),
		"system_spool_stats_ingress_messages_async_replicated":      NewSemDesc("system_spool_stats_ingress_messages_async_replicated", NoSempV2Ready, "Ingress messages async replicated.", nil),
		"system_spool_stats_ingress_messages_sync_replicated":       NewSemDesc("system_spool_stats_ingress_messages_sync_replicated", NoSempV2Ready, "Ingress messages sync replicated.", nil),
		"system_spool_stats_ingress_messages_from_replication_mate": NewSemDesc("system_spool_stats_ingress_messages_from_replication_mate", NoSempV2Ready, "Ingress messages from replication mate.", nil),
		"system_spool_stats_ingress_messages_copied_to_replay_log":  NewSemDesc("system_spool_stats_ingress_messages_copied_to_replay_log", NoSempV2Ready, "Ingress messages copied to replay log.", nil),
		// Sequence number stats
		"system_spool_stats_sequenced_topic_matches":           NewSemDesc("system_spool_stats_sequenced_topic_matches", NoSempV2Ready, "Sequenced topic matches.", nil),
		"system_spool_stats_seq_num_already_assigned":          NewSemDesc("system_spool_stats_seq_num_already_assigned", NoSempV2Ready, "Sequence number already assigned.", nil),
		"system_spool_stats_seq_num_rollover":                  NewSemDesc("system_spool_stats_seq_num_rollover", NoSempV2Ready, "Sequence number rollovers.", nil),
		"system_spool_stats_seq_num_messages_discarded":        NewSemDesc("system_spool_stats_seq_num_messages_discarded", NoSempV2Ready, "Sequence number messages discarded.", nil),
		"system_spool_stats_transacted_messages_not_sequenced": NewSemDesc("system_spool_stats_transacted_messages_not_sequenced", NoSempV2Ready, "Transacted messages not sequenced.", nil),
		// ADB/Disk stats
		"system_spool_stats_spooled_to_adb":                        NewSemDesc("system_spool_stats_spooled_to_adb", NoSempV2Ready, "Messages spooled to ADB.", nil),
		"system_spool_stats_spooled_to_disk":                       NewSemDesc("system_spool_stats_spooled_to_disk", NoSempV2Ready, "Messages spooled to disk.", nil),
		"system_spool_stats_retrieve_from_adb":                     NewSemDesc("system_spool_stats_retrieve_from_adb", NoSempV2Ready, "Messages retrieved from ADB.", nil),
		"system_spool_stats_retrieve_from_disk":                    NewSemDesc("system_spool_stats_retrieve_from_disk", NoSempV2Ready, "Messages retrieved from disk.", nil),
		"system_spool_stats_total_guaranteed_message_cache_misses": NewSemDesc("system_spool_stats_total_guaranteed_message_cache_misses", NoSempV2Ready, "Total guaranteed message cache misses.", nil),
		// Selector stats
		"system_spool_stats_total_ingress_selector_match_messages":    NewSemDesc("system_spool_stats_total_ingress_selector_match_messages", NoSempV2Ready, "Total ingress selector match messages.", nil),
		"system_spool_stats_total_ingress_selector_mismatch_messages": NewSemDesc("system_spool_stats_total_ingress_selector_mismatch_messages", NoSempV2Ready, "Total ingress selector mismatch messages.", nil),
		"system_spool_stats_total_egress_selector_match_messages":     NewSemDesc("system_spool_stats_total_egress_selector_match_messages", NoSempV2Ready, "Total egress selector match messages.", nil),
		"system_spool_stats_total_egress_selector_mismatch_messages":  NewSemDesc("system_spool_stats_total_egress_selector_mismatch_messages", NoSempV2Ready, "Total egress selector mismatch messages.", nil),
		// Egress stats
		"system_spool_stats_total_discarded_egress_messages":           NewSemDesc("system_spool_stats_total_discarded_egress_messages", NoSempV2Ready, "Total discarded egress messages.", nil),
		"system_spool_stats_egress_messages":                           NewSemDesc("system_spool_stats_egress_messages", NoSempV2Ready, "Total egress messages.", nil),
		"system_spool_stats_egress_messages_redelivered":               NewSemDesc("system_spool_stats_egress_messages_redelivered", NoSempV2Ready, "Egress messages redelivered.", nil),
		"system_spool_stats_egress_messages_transport_retransmit":      NewSemDesc("system_spool_stats_egress_messages_transport_retransmit", NoSempV2Ready, "Egress messages transport retransmit.", nil),
		"system_spool_stats_confirmed_delivered":                       NewSemDesc("system_spool_stats_confirmed_delivered", NoSempV2Ready, "Confirmed delivered messages.", nil),
		"system_spool_stats_confirmed_delivered_store_and_forward":     NewSemDesc("system_spool_stats_confirmed_delivered_store_and_forward", NoSempV2Ready, "Confirmed delivered store and forward messages.", nil),
		"system_spool_stats_confirmed_delivered_cut_through":           NewSemDesc("system_spool_stats_confirmed_delivered_cut_through", NoSempV2Ready, "Confirmed delivered cut through messages.", nil),
		"system_spool_stats_confirmed_delivered_from_replication_mate": NewSemDesc("system_spool_stats_confirmed_delivered_from_replication_mate", NoSempV2Ready, "Confirmed delivered from replication mate.", nil),
		"system_spool_stats_request_for_redelivery":                    NewSemDesc("system_spool_stats_request_for_redelivery", NoSempV2Ready, "Requests for redelivery.", nil),
		// Session stats
		"system_spool_stats_open_session":                       NewSemDesc("system_spool_stats_open_session", NoSempV2Ready, "Open session requests.", nil),
		"system_spool_stats_open_session_success":               NewSemDesc("system_spool_stats_open_session_success", NoSempV2Ready, "Successful open session requests.", nil),
		"system_spool_stats_open_session_max_sessions_exceeded": NewSemDesc("system_spool_stats_open_session_max_sessions_exceeded", NoSempV2Ready, "Open session failures due to max sessions exceeded.", nil),
		"system_spool_stats_open_session_other_failures":        NewSemDesc("system_spool_stats_open_session_other_failures", NoSempV2Ready, "Open session other failures.", nil),
		// Transaction stats
		"system_spool_stats_transactions":                                 NewSemDesc("system_spool_stats_transactions", NoSempV2Ready, "Total transactions.", nil),
		"system_spool_stats_transactions_success":                         NewSemDesc("system_spool_stats_transactions_success", NoSempV2Ready, "Successful transactions.", nil),
		"system_spool_stats_transactions_commit":                          NewSemDesc("system_spool_stats_transactions_commit", NoSempV2Ready, "Transaction commits.", nil),
		"system_spool_stats_transactions_rollback":                        NewSemDesc("system_spool_stats_transactions_rollback", NoSempV2Ready, "Transaction rollbacks.", nil),
		"system_spool_stats_transactions_fail":                            NewSemDesc("system_spool_stats_transactions_fail", NoSempV2Ready, "Failed transactions.", nil),
		"system_spool_stats_transactions_msgs_spooled_to_adb":             NewSemDesc("system_spool_stats_transactions_msgs_spooled_to_adb", NoSempV2Ready, "Transaction messages spooled to ADB.", nil),
		"system_spool_stats_transactions_msgs_retrieved_from_adb_or_disk": NewSemDesc("system_spool_stats_transactions_msgs_retrieved_from_adb_or_disk", NoSempV2Ready, "Transaction messages retrieved from ADB or disk.", nil),
		"system_spool_stats_transactions_msgs_published":                  NewSemDesc("system_spool_stats_transactions_msgs_published", NoSempV2Ready, "Transaction messages published.", nil),
		"system_spool_stats_transactions_msgs_consumed":                   NewSemDesc("system_spool_stats_transactions_msgs_consumed", NoSempV2Ready, "Transaction messages consumed.", nil),
		"system_spool_stats_max_transactions_exceeded":                    NewSemDesc("system_spool_stats_max_transactions_exceeded", NoSempV2Ready, "Max transactions exceeded.", nil),
		"system_spool_stats_max_transaction_resources_exceeded":           NewSemDesc("system_spool_stats_max_transaction_resources_exceeded", NoSempV2Ready, "Max transaction resources exceeded.", nil),
		// XA session stats
		"system_spool_stats_xa_open_session":                       NewSemDesc("system_spool_stats_xa_open_session", NoSempV2Ready, "XA open session requests.", nil),
		"system_spool_stats_xa_open_session_success":               NewSemDesc("system_spool_stats_xa_open_session_success", NoSempV2Ready, "Successful XA open session requests.", nil),
		"system_spool_stats_xa_open_session_max_sessions_exceeded": NewSemDesc("system_spool_stats_xa_open_session_max_sessions_exceeded", NoSempV2Ready, "XA open session failures due to max sessions exceeded.", nil),
		"system_spool_stats_xa_open_session_other_failures":        NewSemDesc("system_spool_stats_xa_open_session_other_failures", NoSempV2Ready, "XA open session other failures.", nil),
		// XA transaction stats
		"system_spool_stats_xa_transactions":                                 NewSemDesc("system_spool_stats_xa_transactions", NoSempV2Ready, "Total XA transactions.", nil),
		"system_spool_stats_xa_transactions_success":                         NewSemDesc("system_spool_stats_xa_transactions_success", NoSempV2Ready, "Successful XA transactions.", nil),
		"system_spool_stats_xa_transactions_fail":                            NewSemDesc("system_spool_stats_xa_transactions_fail", NoSempV2Ready, "Failed XA transactions.", nil),
		"system_spool_stats_xa_transactions_msgs_spooled_to_adb":             NewSemDesc("system_spool_stats_xa_transactions_msgs_spooled_to_adb", NoSempV2Ready, "XA transaction messages spooled to ADB.", nil),
		"system_spool_stats_xa_transactions_msgs_retrieved_from_adb_or_disk": NewSemDesc("system_spool_stats_xa_transactions_msgs_retrieved_from_adb_or_disk", NoSempV2Ready, "XA transaction messages retrieved from ADB or disk.", nil),
		"system_spool_stats_xa_transactions_msgs_published":                  NewSemDesc("system_spool_stats_xa_transactions_msgs_published", NoSempV2Ready, "XA transaction messages published.", nil),
		"system_spool_stats_xa_transactions_msgs_consumed":                   NewSemDesc("system_spool_stats_xa_transactions_msgs_consumed", NoSempV2Ready, "XA transaction messages consumed.", nil),
		"system_spool_stats_xa_max_transactions_exceeded":                    NewSemDesc("system_spool_stats_xa_max_transactions_exceeded", NoSempV2Ready, "XA max transactions exceeded.", nil),
		"system_spool_stats_xa_max_transaction_resources_exceeded":           NewSemDesc("system_spool_stats_xa_max_transaction_resources_exceeded", NoSempV2Ready, "XA max transaction resources exceeded.", nil),
		// Replay stats
		"system_spool_stats_replays_initiated":       NewSemDesc("system_spool_stats_replays_initiated", NoSempV2Ready, "Replays initiated.", nil),
		"system_spool_stats_replays_succeeded":       NewSemDesc("system_spool_stats_replays_succeeded", NoSempV2Ready, "Replays succeeded.", nil),
		"system_spool_stats_replays_failed":          NewSemDesc("system_spool_stats_replays_failed", NoSempV2Ready, "Replays failed.", nil),
		"system_spool_stats_replayed_messages_sent":  NewSemDesc("system_spool_stats_replayed_messages_sent", NoSempV2Ready, "Replayed messages sent.", nil),
		"system_spool_stats_replayed_messages_acked": NewSemDesc("system_spool_stats_replayed_messages_acked", NoSempV2Ready, "Replayed messages acknowledged.", nil),
		// Rate stats
		"system_spool_stats_current_bind_rate_per_second": NewSemDesc("system_spool_stats_current_bind_rate_per_second", NoSempV2Ready, "Current bind rate per second.", nil),
		"system_spool_stats_average_bind_rate_per_minute": NewSemDesc("system_spool_stats_average_bind_rate_per_minute", NoSempV2Ready, "Average bind rate per minute.", nil),
	},
	"Redundancy": {
