...
| ClientMessageSpoolEgress              | no         | yes         | no             | may harm broker if many clients                                       | show client itemFilter message-spool egress connected (paged)                      | software, appliance |
| ClientMessageSpoolStats               | no         | yes         | no             | may harm broker if many clients                                       | show client itemFilter stats(paged)                                                | software, appliance |
